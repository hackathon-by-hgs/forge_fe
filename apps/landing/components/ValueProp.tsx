...
export default function ValueProp() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#F9F9F9] py-24 md:py-48 overflow-hidden">
      {/* Subtle background text */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none overflow-hidden w-full whitespace-nowrap opacity-[0.02]">
        <span className="text-[30vw] font-black uppercase tracking-tighter text-black">ECOSYSTEM</span>
      </div>
