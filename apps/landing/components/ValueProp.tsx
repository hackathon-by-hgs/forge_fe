  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="sticky top-0 h-screen w-full overflow-hidden border-r border-black/5 bg-[linear-gradient(120deg,rgba(255,255,255,0.88)_0%,rgba(255,255,255,0.66)_45%,rgba(255,255,255,0.4)_100%)] shadow-[30px_0_100px_rgba(0,0,0,0.1)] backdrop-blur-[1.5px]"
      >
